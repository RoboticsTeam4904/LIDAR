...
// changes vector into cartesian coordinates
...
// returns slope between two pointsz
...
changes individual points into groups
groups which are easier to read by the 
...
inputs blurred points and outputs the walls 
which have been detected by the LIDAR

NOTICE: Pending improvement to the algorithm
